"""
Script : PhoneSploit
Author : DK Hacker (github.com/Dk-Hacker357)
"""
...
def check_packages():
    ...
    if (
        ...
        choice = input(
            f"\n{color.GREEN}Do you still want to continue to PhoneSploit ?{color.WHITE}     Y / N > "
        ).lower()
...
def exit_phonesploit():
    global run_phonesploit
    run_phonesploit = False
    print("\nExiting...\n")
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to PhoneSploit/{screenshot_location}\n{color.WHITE}"
        )
    else:
        print(
...
def screenrecord():
    ...
    if screenrecord_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving video to PhoneSploit/{screenrecord_location}\n{color.WHITE}"
        )
    else:
...
def pull_file():
    ...
    if pull_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving file to PhoneSploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving data to PhoneSploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_screenshots():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Screenshots to PhoneSploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_camera():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Photos to PhoneSploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_sms():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving SMS file to PhoneSploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_call_logs():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Call Logs file to PhoneSploit/{pull_location}\n{color.WHITE}"
        )
    else:
        print(
...
def extract_apk():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving APK file to PhoneSploit/{pull_location}\n{color.WHITE}"
        )
    else:
...
def instagram():
     os.system(f"{opener} https://www.instagram.com/_dk_hacker_/")
     print("\n")

def visit_me():
    os.system(f"{opener} https://www.youtube.com/@dk_hacker")
    print("\n")
