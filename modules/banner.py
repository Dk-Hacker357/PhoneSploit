...
menu3 = f"""
    ...
    {color.WHITE}34. {color.GREEN}Dump All Contacts           {color.WHITE}39. {color.GREEN}Use Keycodes (Control Device)       {color.WHITE}44. {color.GREEN}Follow me on Instagram
    {color.WHITE}35. {color.GREEN}Dump Call Logs              {color.WHITE}40. {color.GREEN}Listen Mic Audio                    {color.WHITE}45. {color.GREEN}Subscribe my YouTube Channel
...
banner2 = f"""
        ...
        ░█─── ▀──▀ ▀▀▀▀ ▀──▀ ▀▀▀ ░█▄▄▄█ █▀▀▀ ▀▀▀ ▀▀▀▀ ▀▀▀ ──▀──
            ...
            {color.RED}{version}{color.WHITE}            {color.WHITE}By github.com/Dk-Hacker357
"""
...
banner4 = f"""
    ...
    \______  \\  |__   ____   ____   ____  /   _____/_____ |  |   ____ |__|/  |_    
    |     ___/  |  \ /  _ \ /    \_/ __ \ \_____  \\\____ \|  |  /  _ \|  \   __\  
    |    |   |   Y  (  <_> )   |  \  ___/ /        \  |_> >  |_(  <_> )  ||  |    
    |____|   |___|  /\____/|___|  /\___  >_______  /   __/|____/\____/|__||__|   
                  \/            \/     \/        \/|__|                                                      
...
banner5 = f"""
       ___  __                 ____     __     _ __         
      / _ \/ /  ___  ___  ___ / __/__  / /__  (_) /_
     / ___/ _ \/ _ \/ _ \/ -_)\ \/ _ \/ / _ \/ / __/
    /_/  /_//_/\___/_//_/\__/___/ .__/_/\___/_/\__/ 
                               /_/                                                                                                      
...
banner10 = f"""
     ____    __                              ____            ___               __                             
    /\  _`\ /\ \                            /\  _`\         /\_ \           __/\ \__                          
    \ \ \L\ \ \ \___     ___     ___      __\ \,\L\_\  _____\//\ \     ___ /\_\ \ ,_\             
     \ \ ,__/\ \  _ `\  / __`\ /' _ `\  /'__`\/_\__ \ /\ '__`\\\ \ \   / __`\/\ \ \ \/          
      \ \ \/  \ \ \ \ \/\ \L\ \/\ \/\ \/\  __/ /\ \L\ \ \ \L\ \\\_\ \_/\ \L\ \ \ \ \ \_        
       \ \_\   \ \_\ \_\ \____/\ \_\ \_\ \____\\\ `\____\ \ ,__//\____\ \____/\ \_\ \__\     
        \/_/    \/_/\/_/\/___/  \/_/\/_/\/____/ \/_____/\ \ \/ \/____/\/___/  \/_/\/__/       
                                                         \ \_\                                                       
                                                          \/_/                                              
...
banner11 = f"""
    ...
    ___  __ \__  /_____________________  ___/__________  /________(_)_  /_     
    __  /_/ /_  __ \  __ \_  __ \  _ \____ \___  __ \_  /_  __ \_  /_  __/
    _  ____/_  / / / /_/ /  / / /  __/___/ /__  /_/ /  / / /_/ /  / / /_  
    /_/     /_/ /_/\____//_/ /_/\___//____/ _  .___//_/  \____//_/  \__/  
                                             /_/                                      
